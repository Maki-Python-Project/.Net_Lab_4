...
namespace Lab4
{
    internal class StudentCollection
    {
        ...
        public void AddDefaults()
        {
           ...
           Add(new Student());
           Add(new Student(new Person("Volodymyr", "Prokopechko", new DateOnly(2002, 10, 21)), Education.Master, 405) { Exams = new List<Exam>() { new Exam(), new Exam("Programming", 2, new DateOnly(2021, 6, 3)) } });
        }
